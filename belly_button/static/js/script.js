...
function pieChart(value){
    ...
    Plotly.d3.json(url + value, (error, data) => {
        ...
        Plotly.d3.json('/otu', (e,d) => {
          ...
          var layout = {
            title: value + "'s <br>Top 10 OTU Microbiomes"
          };
...
function bubbleChart(value){
    ...
    Plotly.d3.json(url + value, (error, data) => {
        ...
        Plotly.d3.json("/otu", (e, d) => {
          ...
          var layout = {
              title: value  + "'s Operational Taxonimical Unit's (OTU) <br>Volume and Spread",
              showLegend: false
          }
...
function gaugeChart(value){
    ...
    Plotly.d3.json(url + value, (error, data) => {
        ...
        var layout = {
          ...
          title: value + ' Belly Button <br> Weekly Washing Frequency',
